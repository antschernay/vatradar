...
const Toolbar = ({ planesAreShown, setPlanesAreShown, panelIsShown, setPanelIsShown, 
                    ...
                    polygonsAreShown, setPolygonsAreShown}) => {
    ...
    return (
        <>
            ...
            <div className='flex justify-start toolbar o-90 mh3 code'>
                <div className='flex'>
                    <img
                    className={`pa2 mr0 pointer br3 ${panelIsShown ? 'bg-white' : ''}`}
                    src={glass}
                    alt="glass"
                    width="27"
                    height="27"
                    ...
                    <img
                    className={`pa2 mh2 pointer br3 ${planesAreShown ? 'bg-white' : ''}`}
                    src={airplane}
                    alt="airplane"
                    width="27"
                    height="27"
                    ...
                    <img
                    className={`pa2 pointer br3 ${airportsAreShown ? 'bg-white' : ''}`}
                    src={airport}
                    alt="airport"
                    width="27"
                    height="27"
                    ...
                    <img
                    className={`pa2 mh2 pointer br3 ${atcAreShown ? 'bg-white' : ''}`}
                    src={atc}
                    alt="atc"
                    width="27"
                    height="27"
                    ...
                    <img
                    className={`pa2 pointer br3 ${polygonsAreShown ? 'bg-white' : ''}`}
                    src={earth}
                    alt="earth"
                    width="27"
                    height="27"
                    onClick={() => setPolygonsAreShown(!polygonsAreShown)}
                    />
                </div>
            </div>
        </>
